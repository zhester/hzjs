...
structure with lots of reasonable default properties/behaviors.
...
The only time styling is ever specified here is when a style is an aspect of
the element's behavior (e.g. the width of a progress bar).
