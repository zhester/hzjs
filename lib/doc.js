...
hz.doc = ( function( ns ) {
     ...
     *  document fragment.
     *
     *  The specification string is known as DTN: Document Tree Notation.  It
     *  is currently documented in development/dtn.txt
     *
     *  Note: This is intended to replace the hz.doc.structure class.  It's
     *  use is considered deprecated for new code.
     *
     *  @param dtn Document Tree Notation string
     *  @param     An HTMLCollection-compatible object of the document
