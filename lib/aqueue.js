...
/**
 *  Asynchronous procedure queue.  Create one of these to execute a sequence
 ...
 *          this.queue.complete();
 *      };
 *      //create the queue, and load a bunch of steps with delayed execution
 *      var sequence = aqueue();
 *      sequence.ondone = function() { console.log( 'all done!' ); };
 *      for( var i = 0; i < 4; ++i ) {
