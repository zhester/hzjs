...
hz.data = ( function( ns ) {
    ...
    ns.fetch_object = function( uri, handler ) {
        var xhr = create_json_request( handler );
     ...
     *  @throws      Error if the field can't be removed
     */
    record_set.prototype.remove_field = function( field ) {
        ...
        if( typeof field === 'integer' ) {
            ...
            remove = this.fields.indexOf( field );
        }
        if( ( remove >= 0 ) && ( remove < this.fields.length ) ) {
            ...
            throw new Error( 'Unable to remove field: ' + field );
        }
    };
     ...
     */
    function create_json_request( json_handler ) {
        ...
        xhr.onload = function( event ) {
            ...
            try {
                ...
                throw new Error( 'Unable to parse JSON response: ' + text );
            }
            json_handler( data );
        };
        return xhr;
