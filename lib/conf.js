/*****************************************************************************
    Hz Library Persistent User Configuration

    Eliminates the need for server-side storage and/or cookies to store basic
    user-defined configuration values.

    Includes a feature to track configuration values that must be specified
    for the configuration to register as valid.
    ...
    Example usage:
        ...
        //first time ever creating this object:
        conf.is_valid();                    //returns false
        conf.is_specified( 'user' );        //returns false
        conf.is_specified( 'theme' );       //returns true

        //at some point...
        conf.set( 'user', 'Homer Simpson' );

        //at any time after that:
        conf.is_valid();                    //returns true
        conf.is_specified( 'user' );        //returns true
